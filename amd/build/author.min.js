            ...
            postJson('upload_token.php', {title: file.name || state.title || 'Untitled video'})
                .then(function(res) {
                    return res.ok ? res.json() : res.json().then(function(b) {
                        throw new Error(b.error || 'Upload token failed');
                    });
                })
                .then(function(token) {
